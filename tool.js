...
const ToolDate = {
    ...
    */
    ...
    getYearOfDay(time) {
        ...
        var numSecond = (newDate(lastDayYear).getTime() - newDate(firstDayYear).getTime()) / 1000;
    ...
    getFirstDayOfYear(time) {
        ...
        var year = newDate(time).getFullYear();
    ...
    getDayOfYear(time) {
        ...
        var numSecond = (newDate(time).getTime() - newDate(firstDayYear).getTime()) / 1000;
...
const ToolStrAndNum = {
    ...
    */
    ...
    numberToChinese(num) {
        ...
        var AA = newArray("零", "一", "二", "三", "四", "五", "六", "七", "八", "九", "十");

        var BB = newArray("", "十", "百", "仟", "萬", "億", "点", "");
...
const ToolDom = {
    ...
    hasClass(ele, name) {
        ...
        return ele.className.match(newRegExp('(\\s|^)' + name + '(\\s|$)'));
...
const ToolOthers = {
    ...
    getRandomColor() {
        ...
        return '#' + (function (h) {
            ...
            return newArray(7 - h.length).join("0") + h;
